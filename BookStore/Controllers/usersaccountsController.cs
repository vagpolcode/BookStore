...
namespace BookStore.Controllers
{
    public class usersaccountsController : Controller
    {
        ...
        public usersaccountsController(BookStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.usersaccounts != null ? 
                          ...
                          Problem("Entity set 'BookStoreContext.usersaccounts'  is null.");
        }
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\vagpol5\\Documents\\BookStoreDB.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
